export default async function handler(req, res) {
  ...
  try {
    const response = await fetch("https://api.anthropic.com/v1/messages", {
      ...
      body: JSON.stringify({ model: "claude-sonnet-4-20250514", max_tokens: 3000, tools: [{ type: "web_search_20250305", name: "web_search" }], system: "You are a JSON-only API. Never output prose, markdown, or code fences. Only output a single raw JSON object.", messages: [{ role: "user", content: "Search current 2025-26 NHL season stats for " + awayTeam + " and " + homeTeam + ". Reply with ONLY this JSON (fill real values): {\"home\":{\"wins\":0,\"losses\":0,\"otl\":0,\"points\":0,\"gf_pg\":3.1,\"ga_pg\":2.8,\"pp_pct\":21.5,\"pk_pct\":81.0,\"shots_pg\":31.2,\"shots_against_pg\":29.8,\"save_pct\":0.912,\"last10\":\"6-2-2\",\"last10_gf\":3.2,\"last10_ga\":2.6,\"goalie\":{\"name\":\"Starter Name\",\"save_pct\":0.912,\"gaa\":2.45,\"starts\":28,\"status\":\"PLAYING\"},\"roster\":[{\"name\":\"Player Name\",\"position\":\"LW\",\"goals\":18,\"assists\":26,\"points\":44,\"plus_minus\":8,\"role\":\"STAR\",\"status\":\"PLAYING\"}]},\"away\":{\"wins\":0,\"losses\":0,\"otl\":0,\"points\":0,\"gf_pg\":3.1,\"ga_pg\":2.8,\"pp_pct\":21.5,\"pk_pct\":81.0,\"shots_pg\":31.2,\"shots_against_pg\":29.8,\"save_pct\":0.912,\"last10\":\"6-2-2\",\"last10_gf\":3.2,\"last10_ga\":2.6,\"goalie\":{\"name\":\"Starter Name\",\"save_pct\":0.912,\"gaa\":2.45,\"starts\":28,\"status\":\"PLAYING\"},\"roster\":[{\"name\":\"Player Name\",\"position\":\"LW\",\"goals\":18,\"assists\":26,\"points\":44,\"plus_minus\":8,\"role\":\"STAR\",\"status\":\"PLAYING\"}]}} Include ALL active skaters (typically 18-20, no goalies in roster array) per team sorted by points. role=STAR if pts>40, KEY if pts>20, else ROLE. status=OUT/DOUBTFUL/QUESTIONABLE/PLAYING." }] })
    });
