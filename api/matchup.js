export default async function handler(req, res) {
  ...
  try {
    const response = await fetch("https://api.anthropic.com/v1/messages", {
      ...
      body: JSON.stringify({ model: "claude-sonnet-4-20250514", max_tokens: 2000, tools: [{ type: "web_search_20250305", name: "web_search" }], system: "You are a JSON-only API. Never output prose, markdown, or code fences. Only output a single raw JSON object.", messages: [{ role: "user", content: "Search current 2025-26 NBA season stats for " + awayTeam + " and " + homeTeam + ". Reply with ONLY this JSON (fill real values): {\"home\":{\"wins\":0,\"losses\":0,\"ppg\":112.5,\"opp\":109.2,\"efg_pct\":0.535,\"tov_rate\":13.1,\"oreb_pct\":0.27,\"ftr\":0.21,\"opp_efg_pct\":0.521,\"opp_tov_rate\":13.8,\"opp_oreb_pct\":0.25,\"opp_ftr\":0.20,\"last10\":\"7-3\",\"last10_ppg\":114.0,\"last10_opp\":108.5,\"roster\":[{\"name\":\"Player Name\",\"ppg\":24.5,\"per\":22.1,\"role\":\"STAR\",\"status\":\"PLAYING\"}]},\"away\":{\"wins\":0,\"losses\":0,\"ppg\":112.5,\"opp\":109.2,\"efg_pct\":0.535,\"tov_rate\":13.1,\"oreb_pct\":0.27,\"ftr\":0.21,\"opp_efg_pct\":0.521,\"opp_tov_rate\":13.8,\"opp_oreb_pct\":0.25,\"opp_ftr\":0.20,\"last10\":\"7-3\",\"last10_ppg\":114.0,\"last10_opp\":108.5,\"roster\":[{\"name\":\"Player Name\",\"ppg\":24.5,\"per\":22.1,\"role\":\"STAR\",\"status\":\"PLAYING\"}]}} Include 7 real players per team sorted by ppg. role=STAR if ppg>20, KEY if ppg>11, else ROLE. status=OUT/DOUBTFUL/QUESTIONABLE/PLAYING." }] })
    });
