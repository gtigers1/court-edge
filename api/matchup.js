  ...
  try {
    const response = await fetch("https://api.anthropic.com/v1/messages", {
      ...
      body: JSON.stringify({
        ...
        system: "You are a JSON-only API. Output only a single raw JSON object, no prose, no markdown, no code fences.",
        messages: [{ role: "user", content: "Search 2025-26 NBA stats for " + awayTeam + " and " + homeTeam + ". Return ONLY this JSON with real values: {\"home\":{\"wins\":20,\"losses\":15,\"ppg\":112.5,\"opp\":109.2,\"efg_pct\":0.535,\"tov_rate\":13.1,\"oreb_pct\":0.27,\"ftr\":0.21,\"opp_efg_pct\":0.521,\"opp_tov_rate\":13.8,\"opp_oreb_pct\":0.25,\"opp_ftr\":0.20,\"last10\":\"7-3\",\"last10_ppg\":114.0,\"last10_opp\":108.5,\"roster\":[{\"name\":\"Player Name\",\"ppg\":24.5,\"per\":22.1,\"role\":\"STAR\",\"status\":\"PLAYING\"}]},\"away\":{\"wins\":20,\"losses\":15,\"ppg\":112.5,\"opp\":109.2,\"efg_pct\":0.535,\"tov_rate\":13.1,\"oreb_pct\":0.27,\"ftr\":0.21,\"opp_efg_pct\":0.521,\"opp_tov_rate\":13.8,\"opp_oreb_pct\":0.25,\"opp_ftr\":0.20,\"last10\":\"7-3\",\"last10_ppg\":114.0,\"last10_opp\":108.5,\"roster\":[{\"name\":\"Player Name\",\"ppg\":24.5,\"per\":22.1,\"role\":\"STAR\",\"status\":\"PLAYING\"}]}} Include ALL active players (13-15) per team sorted by ppg. role=STAR if ppg>20, KEY if ppg>11, else ROLE." }]
      })
    });
