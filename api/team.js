  ...
  try {
    ...
    if (sport === "nba") {
      ...
      const baseResult = {
        wins,
        losses,
        ppg:          espnTeamStats.ppg          || schedPPG || 114,
        opp:          espnTeamStats.opp          || schedOPP || 114,
        ...
        last10_ppg: l10ppg != null ? parseFloat(l10ppg.toFixed(1)) : (espnTeamStats.ppg || schedPPG || 114),
        last10_opp: l10opp != null ? parseFloat(l10opp.toFixed(1)) : (espnTeamStats.opp || schedOPP || 114),
